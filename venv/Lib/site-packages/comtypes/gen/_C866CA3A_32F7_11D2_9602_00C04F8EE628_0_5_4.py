...
__all__ = [
    'SAFT24kHz8BitStereo', 'DISPID_SRCResume',
    'DISPID_SDKSetLongValue', 'SBONone', 'DISPID_SVEBookmark',
    'SPPS_RESERVED1', 'SECLowConfidence', 'DISPID_SRGCommit', 'SVP_6',
    'SVESentenceBoundary', 'DISPID_SRGDictationUnload',
    'SAFT8kHz16BitMono', 'SPEI_TTS_AUDIO_LEVEL', 'SPEI_SR_PRIVATE',
    'DISPID_SPEActualConfidence', 'SAFTCCITT_uLaw_44kHzMono',
    'SREStateChange', 'SVSFParseMask', 'SPAR_Unknown',
    'SPSERIALIZEDRESULT', 'DISPID_SPRDisplayAttributes',
    'DISPID_SGRSTRule', 'SAFT22kHz16BitStereo', 'SAFTADPCM_44kHzMono',
    'eLEXTYPE_PRIVATE16', 'DISPID_SLGenerationId',
    'SREFalseRecognition', 'SpeechCategoryAudioIn',
    'DISPID_SAFGetWaveFormatEx', 'SpeechCategoryAppLexicons',
    'SAFTGSM610_22kHzMono', 'ISpeechRecoResult', 'SASPause',
    'DISPID_SAFType', 'DISPID_SVSInputSentenceLength',
    'DISPID_SWFEChannels', 'DISPID_SGRSRule',
    'SAFTExtendedAudioFormat', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SVGetVoices', 'SVSFIsNotXML', 'eLEXTYPE_APP', 'SPAR_High',
    'ISpPhoneConverter', 'DISPID_SRCRetainedAudioFormat',
    'SP_VISEME_14', 'SpTextSelectionInformation',
    'SPSHT_NotOverriden', 'SLTApp', 'DISPID_SRGReset',
    'DISPID_SFSOpen', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPRS_ACTIVE', 'SAFTADPCM_44kHzStereo', 'eLEXTYPE_PRIVATE2',
    'DISPID_SpeechAudio', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SDKEnumValues', 'ISpObjectWithToken',
    'SDA_Consume_Leading_Spaces', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SpeechGrammarRules', 'SpeechTokenKeyFiles',
    'DISPID_SOTGetDescription', 'eLEXTYPE_RESERVED6', 'SpShortcut',
    'IInternetSecurityMgrSite', 'SPEVENTENUM', 'DISPID_SRCESoundEnd',
    ...
    'SECNormalConfidence', 'SPWT_PRONUNCIATION', 'ISequentialStream',
    'ISpeechDataKey', 'SVF_Stressed', 'DISPID_SMSSetData',
    'SVSFVoiceMask', 'DISPID_SRSetPropertyNumber',
    'DISPID_SPRuleName', 'DISPID_SASState', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SBSFormat', 'SpCustomStream', 'ISpeechCustomStream',
    'DISPID_SpeechRecoResult', 'SAFTNonStandardFormat',
    'SREAudioLevel', 'SVP_15', 'SVEAllEvents',
    'SpeechGrammarWordType', 'DISPID_SpeechPhraseAlternate',
    'tagSPTEXTSELECTIONINFO', 'SPSInterjection',
    'DISPID_SRSSupportedLanguages', 'SP_VISEME_15', 'SpeechRunState',
    'DISPID_SVStatus', 'DISPID_SPRFirstElement', 'SECFIgnoreCase',
    'SPDKL_DefaultLocation', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SpeechXMLRecoResult', 'ISpGrammarBuilder',
    'eLEXTYPE_PRIVATE9', 'DISPID_SGRAddState', 'SRTSMLTimeout',
    'DISPID_SDKDeleteValue', 'SPINTERFERENCE_NOSIGNAL',
    'ISpeechResourceLoader', 'DISPID_SRRTOffsetFromStart',
    'eLEXTYPE_PRIVATE17', 'SVPAlert', 'SPSEMANTICFORMAT',
    'DISPID_SRGetPropertyString', 'SECHighConfidence',
    'DISPID_SPPs_NewEnum', 'SPCT_SUB_DICTATION',
    'DISPID_SpeechRecoContextEvents', 'ISpeechPhraseProperties',
    'DISPID_SVAudioOutput', 'DISPID_SRState',
    'DISPID_SRIsUISupported', 'SpMemoryStream',
    'DISPID_SRCRetainedAudio', 'SAFT48kHz16BitStereo', 'SPAS_STOP',
    'SP_VISEME_11', 'SITooFast', 'SpeechCategoryRecoProfiles',
    'DISPID_SpeechObjectTokenCategory', 'SREPrivate',
    'SpSharedRecognizer', 'SPEI_WORD_BOUNDARY', 'DISPID_SLPsItem',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpeechDisplayAttributes',
    'SVSFIsFilename', 'SpeechRegistryUserRoot',
    'DISPID_SpeechPhraseProperty', 'DISPID_SVEStreamStart',
    'DISPID_SGRSTType', 'SpObjectTokenCategory', 'SP_VISEME_8',
    'SVP_3', 'SLTUser', 'SINoSignal', 'DISPID_SRRAudio',
    'DISPID_SMSGetData', 'SAFT32kHz8BitMono', 'SPEI_SR_AUDIO_LEVEL',
    'SPXRO_SML', 'SPRST_ACTIVE_ALWAYS', 'tagSTATSTG', 'SVSFParseSapi',
    'SVSFNLPMask', 'ISpObjectTokenCategory', 'DISPID_SRCRecognizer',
    'SVEWordBoundary', 'SGDSInactive', 'SPEI_END_SR_STREAM',
    'SP_VISEME_4', 'DISPID_SASFreeBufferSpace', 'DISPID_SGRs_NewEnum',
    'SpObjectToken', 'SpeechLoadOption', 'DISPID_SRRTTickCount',
    'SPINTERFERENCE', 'DISPID_SRIsShared', 'SPSTREAMFORMATTYPE',
    'SRATopLevel', 'eLEXTYPE_PRIVATE10', 'SRSEDone', 'SRERequestUI',
    'DISPID_SOTCSetId', 'SpeechRecoProfileProperties',
    'DISPID_SGRAddResource', 'SRCS_Disabled', 'SPEI_VOICE_CHANGE',
    'SpeechRuleAttributes', 'SASStop', 'SWPUnknownWordPronounceable',
    'SPPS_SuppressWord', 'SRTReSent', 'SGSEnabled',
    'DISPID_SpeechPhoneConverter', 'Speech_StreamPos_Asap',
    'DISPID_SDKCreateKey', 'DISPID_SPRuleFirstElement',
    'SPPS_Noncontent', 'DISPID_SpeechGrammarRule', 'SPWT_DISPLAY',
    'SVF_Emphasis', 'DISPID_SGRsCommitAndSave', 'DISPID_SRRTimes',
    'DISPID_SGRSTWeight', 'SpeechEmulationCompareFlags',
    'SPEI_INTERFERENCE', 'DISPID_SVESentenceBoundary',
    'SpeechEngineConfidence', 'SPLO_STATIC',
    'DISPID_SRGCmdSetRuleIdState', 'SAFT24kHz8BitMono',
    'ISpeechVoiceStatus', 'SpStream', 'SRCS_Enabled',
    '_ISpeechVoiceEvents', 'SP_VISEME_10',
    'DISPID_SAFSetWaveFormatEx', 'SpFileStream',
    'DISPID_SPELexicalForm', 'SPRULESTATE', 'SRESoundEnd',
    'DISPID_SOTCategory', 'DISPID_SpeechMemoryStream',
    'SpeechRegistryLocalMachineRoot', 'STCInprocHandler', 'SPPS_Verb',
    'DISPID_SRCEPropertyStringChange', 'SPEI_MIN_TTS',
    'SSFMOpenForRead', 'ISpStreamFormatConverter',
    'DISPIDSPTSI_SelectionLength', 'ISpShortcut', 'SPSNotOverriden',
    'DISPID_SPEAudioSizeTime', 'SBOPause',
    'DISPID_SVSInputWordPosition', 'DISPID_SGRSAddRuleTransition',
    'SPGRAMMARSTATE', 'SPPS_Function', 'SpeechDiscardType',
    'DISPID_SRGDictationLoad', 'ISpeechTextSelectionInformation',
    'DISPID_SOTSetId', 'SPCS_ENABLED', 'ISpeechMemoryStream',
    'SPFM_CREATE', 'ISpeechPhraseElements', 'DISPID_SABufferInfo',
    'SREAdaptation', 'SASClosed', 'DISPID_SRCEBookmark',
    'eLEXTYPE_PRIVATE12', 'DISPID_SRRSaveToMemory',
    'SPAO_RETAIN_AUDIO', 'DISPID_SLWLangId', 'SVEEndInputStream',
    'SAFTTrueSpeech_8kHz1BitMono', 'SRESoundStart', 'SPEI_REQUEST_UI',
    'DISPID_SBSSeek', 'DISPID_SPEsCount', 'DISPID_SRRGetXMLErrorInfo',
    'SPPROPERTYINFO', 'SVP_0', 'SGRSTTDictation', 'SP_VISEME_0',
    'SPCT_DICTATION', 'SPCATEGORYTYPE', 'SPVISEMES',
    'DISPID_SLPPhoneIds', 'DISPID_SPARecoResult',
    'DISPID_SPIEnginePrivateData', 'DISPID_SPIEngineId',
    'SPAUDIOOPTIONS', 'SpeechPartOfSpeech',
    'DISPID_SLRemovePronunciation', 'DISPID_SPRuleChildren',
    'DISPID_SRRSpeakAudio', 'SPBO_PAUSE', 'SPSHORTCUTPAIR',
    'SPPHRASE', 'eLEXTYPE_PRIVATE19', 'SGSDisabled', 'DISPID_SLWType',
    'DISPID_SLPPartOfSpeech', 'SAFT16kHz8BitStereo', 'SP_VISEME_16',
    'IInternetSecurityManager', 'DISPID_SPPId', 'DISPID_SRGetFormat',
    'SSSPTRelativeToStart', 'SpeechAudioProperties',
    'eLEXTYPE_PRIVATE13', 'DISPID_SPIAudioSizeTime',
    'SAFT11kHz8BitStereo', 'SAFTADPCM_11kHzMono', 'DISPID_SPPsCount',
    'SpWaveFormatEx', 'SPXMLRESULTOPTIONS', 'DISPID_SVSpeak',
    'SpPhraseInfoBuilder', 'DISPID_SRCAudioInInterferenceStatus',
    'SAFTCCITT_uLaw_8kHzStereo', 'ISpRecoCategory',
    'DISPID_SPPParent', 'SPWAVEFORMATTYPE', 'ISpRecoResult',
    'SPFM_OPEN_READWRITE', 'SPVPRI_ALERT', 'SSSPTRelativeToEnd',
    'SRTAutopause', 'DISPIDSPTSI_ActiveOffset', 'ISpProperties',
    'SPLEXICONTYPE', 'SPEI_PHONEME', 'SRAInterpreter',
    'DISPID_SRRRecoContext', 'SGDisplay', 'DISPID_SPIStartTime',
    'DISPID_SLGetPronunciations', 'DISPID_SPAs_NewEnum',
    'SPDKL_CurrentConfig', 'SPCS_DISABLED', 'SVP_20',
    'DISPID_SpeechLexicon', 'DISPID_SPACommit', 'DISPID_SDKOpenKey',
    'eLEXTYPE_PRIVATE4', 'SRAImport', 'SVP_14', 'SPAR_Medium',
    'DISPID_SPERequiredConfidence', 'SpeechEngineProperties',
    'SAFTADPCM_11kHzStereo', 'DISPID_SOTsCount', 'DISPID_SRCBookmark',
    'DISPID_SOTsItem', 'SAFT24kHz16BitStereo', 'DISPID_SOTRemove',
    'SAFTADPCM_22kHzStereo', 'SFTSREngine', 'SDKLCurrentConfig',
    'DISPID_SpeechLexiconPronunciation', 'SVEAudioLevel',
    'DISPID_SLGetWords', 'SAFT8kHz8BitStereo', 'SRTExtendableParse',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRGRecoContext',
    'DISPID_SPIAudioSizeBytes', 'SWTAdded', 'DISPID_SRCERequestUI',
    'DISPID_SPEAudioSizeBytes', 'SpeechAudioState', 'DISPID_SGRName',
    ...
    'SPGRAMMARWORDTYPE', 'SVSFParseAutodetect', 'SpInprocRecognizer',
    'DISPID_SRGetRecognizers', 'SPGS_ENABLED', 'SSFMOpenReadWrite',
    'DISPID_SAStatus', 'DISPID_SABufferNotifySize',
    'ISpeechRecoContext', 'SpeechStreamFileMode', 'SPSMF_UPS',
    'DISPID_SPRs_NewEnum', 'ISpeechPhraseReplacements',
    'DISPID_SWFEFormatTag', 'SpeechPropertyNormalConfidenceThreshold',
    'SGRSTTRule', 'DISPID_SpeechVoiceEvent',
    'DISPID_SRCSetAdaptationData', 'DISPID_SPIGrammarId',
    'SAFTCCITT_uLaw_8kHzMono', 'SpAudioFormat', 'SLODynamic',
    'SFTInput', 'DISPID_SGRSTs_NewEnum', 'SPRST_ACTIVE',
    'SPEI_RESERVED2', 'SAFT12kHz16BitMono', 'DISPID_SABIBufferSize',
    'SPRECORESULTTIMES', 'SRSEIsSpeaking',
    'DISPID_SRGIsPronounceable', 'DISPID_SVGetAudioInputs',
    'SpeechTokenKeyUI', 'SDA_No_Trailing_Space',
    ...
    'DISPID_SPAsCount', 'SPPS_Modifier', 'SVEViseme',
    'DISPID_SRCEEndStream', 'SpeechWordPronounceable',
    'SSTTTextBuffer', 'SAFTDefault', 'SVSFNLPSpeakPunc',
    'DISPID_SRCVoice', 'SpeechPropertyAdaptationOn', 'ISpRecognizer',
    'SDKLDefaultLocation', 'DISPID_SRRTLength',
    'SDA_Two_Trailing_Spaces', 'DISPID_SRCEStartStream',
    'DISPID_SPRuleId', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpAudio', 'SpNotifyTranslator', 'ISpNotifyTranslator',
    'DISPID_SpeechPhraseRule', 'DISPID_SpeechPhraseReplacement',
    'Speech_Max_Pron_Length', 'STSF_FlagCreate', 'SGRSTTWildcard',
    'DISPID_SVAlertBoundary', 'DISPID_SGRsCount', 'SP_VISEME_12',
    'eWORDTYPE_DELETED', 'SPLO_DYNAMIC', 'SPPHRASEPROPERTY',
    'ISpeechLexiconWord', 'SpeechRecoEvents', 'SPGS_EXCLUSIVE',
    'SPEI_ADAPTATION', 'DISPID_SOTGetStorageFileName', 'SGDSActive',
    'DISPID_SVSyncronousSpeakTimeout', 'SPAUDIOSTATUS',
    'SAFT16kHz16BitStereo', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SVPriority',
    'DISPID_SABIMinNotification', 'tagSPPROPERTYINFO', 'SPEI_VISEME',
    'SPSLMA', 'SECFNoSpecialChars', 'IEnumString', 'SPPHRASERULE',
    'eLEXTYPE_RESERVED7', 'SPINTERFERENCE_NOISE',
    'DISPID_SPRNumberOfElements', 'Speech_Max_Word_Length',
    'DISPID_SPCIdToPhone', 'ISpRecoContext2', 'SVEPrivate',
    'eLEXTYPE_RESERVED9', 'SPVPRI_NORMAL', 'SGDSActiveWithAutoPause',
    'DISPID_SBSRead', 'DISPID_SVWaitUntilDone', 'SPBINARYGRAMMAR',
    'SPWT_LEXICAL', 'DISPID_SGRSTsCount', 'SpeechGrammarTagWildcard',
    'SDTProperty', 'SAFT48kHz8BitStereo',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SDTAudio',
    'SECFIgnoreKanaType', 'WAVEFORMATEX', 'SPSUnknown',
    'SPPS_RESERVED3', 'SPEI_HYPOTHESIS', 'SpeechAllElements',
    'DISPID_SpeechVoiceStatus', 'SWPKnownWordPronounceable',
    'DISPID_SpeechLexiconWords', 'SpeechVoiceSpeakFlags',
    'DISPID_SVEEnginePrivate', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SGRClear', 'SPEI_SR_RETAINEDAUDIO', 'SVP_7',
    'DISPID_SPCLangId', 'IStream', 'SPFM_OPEN_READONLY',
    'SVEBookmark', 'DISPID_SGRSTsItem', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SDKGetBinaryValue', 'SAFT48kHz8BitMono',
    'DISPID_SOTDataKey', 'DISPID_SpeechPhraseRules', 'SPWF_SRENGINE',
    'SPADAPTATIONRELEVANCE', 'SRTEmulated', 'eLEXTYPE_MORPHOLOGY',
    'ISpNotifySink', 'DISPID_SVSInputWordLength', 'ISpRecoGrammar',
    'SP_VISEME_7', 'SGRSTTTextBuffer', 'eLEXTYPE_PRIVATE14',
    'SpeechRecoContextState', 'DISPID_SLWPronunciations', 'SPSNoun',
    'DISPID_SpeechDataKey', 'DISPID_SPRText', 'SPGS_DISABLED',
    'STCRemoteServer', 'SPRULE', 'DISPID_SGRSTNextState', 'SPPS_LMA',
    'SVF_None', 'DISPID_SRGRules', 'DISPID_SRCEventInterests',
    '_SPAUDIOSTATE', 'SDTAll', 'DISPID_SPRules_NewEnum',
    'SPEI_RESERVED5', 'DISPID_SpeechAudioFormat',
    'DISPID_SGRSTPropertyName', 'DISPID_SWFESamplesPerSec',
    'DISPID_SVSLastBookmarkId', 'SpeechPropertyResponseSpeed',
    'eLEXTYPE_PRIVATE5', 'eLEXTYPE_PRIVATE6', 'SASRun', 'ISpDataKey',
    'SPVOICESTATUS', 'SpPhoneConverter', 'SP_VISEME_5',
    'ISpeechXMLRecoResult', 'SPCT_SLEEP', 'SPPS_NotOverriden',
    'SECFEmulateResult', 'DISPID_SPPName', 'DISPID_SOTCreateInstance',
    'IEnumSpObjectTokens', 'SpeechLexiconType',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SRCRequestedUIType',
    'SAFT22kHz16BitMono', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SPEs_NewEnum',
    'SREStreamEnd', 'DISPID_SpeechGrammarRuleState', 'SP_VISEME_13',
    'DISPID_SAVolume', 'SP_VISEME_21', 'ISpRecognizer3',
    ...
    'SpeechVoicePriority', 'SPEI_PHRASE_START',
    'DISPID_SGRSTPropertyId', 'DISPID_SWFEBlockAlign',
    'DISPID_SRCESoundStart', 'DISPID_SRRSetTextFeedback', 'SVPNormal',
    'ISpNotifySource', 'SRAONone', 'DISPID_SOTGetAttribute',
    'ISpeechGrammarRule', 'UINT_PTR', 'SGDSActiveUserDelimited',
    'SVP_10', 'SVEStartInputStream', 'eLEXTYPE_PRIVATE20',
    'DISPID_SGRsItem', 'SPEI_SOUND_START', 'DISPID_SAFGuid',
    'SPEI_SOUND_END', 'eLEXTYPE_PRIVATE1', 'DISPID_SpeechBaseStream',
    'DISPID_SPPFirstElement', 'eLEXTYPE_LETTERTOSOUND',
    'ISpeechAudioStatus', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SpeechVoice', 'LONG_PTR', 'SPPS_Noun',
    'SPEI_RECO_STATE_CHANGE', 'SPLOADOPTIONS',
    'SpeechRecognizerState', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SVEWord', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPAStartElementInResult', 'SAFT44kHz16BitStereo',
    'SAFTCCITT_uLaw_44kHzStereo', 'SpeechCategoryVoices',
    'SpeechBookmarkOptions', 'SPXRO_Alternates_SML',
    'DISPID_SFSClose', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SOTs_NewEnum', 'DISPID_SpeechLexiconProns',
    'ISpeechAudioFormat', 'SPEVENTSOURCEINFO',
    'SpPhoneticAlphabetConverter', 'SPPARTOFSPEECH',
    'ISpeechRecoGrammar', 'SpeechMicTraining', 'ISpeechBaseStream',
    'ISpeechPhraseRule', 'DISPID_SLWWord', 'SPRECOSTATE',
    'SPSERIALIZEDPHRASE', 'DISPID_SLPSymbolic', 'ISpVoice',
    'SPINTERFERENCE_TOOSLOW', 'SPWORDTYPE', 'DISPID_SOTCId',
    'DISPID_SLWsItem', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SpeechAudioStatus',
    'eLEXTYPE_PRIVATE11', 'SWPUnknownWordUnpronounceable',
    'SpeechCategoryAudioOut', 'SPAS_CLOSED', 'SAFT8kHz16BitStereo',
    'SPCONTEXTSTATE', 'SpResourceManager',
    'DISPID_SpeechPhraseProperties', 'SPPS_Interjection', 'SRAExport',
    'SPEI_RESERVED3', 'SECFDefault', 'SPAR_Low', 'SVEVoiceChange',
    'SAFTADPCM_8kHzMono', 'DISPID_SGRId', 'SPWORDPRONOUNCEABLE',
    'ISpLexicon', 'SDTDisplayText', 'DISPID_SOTId',
    'SAFT32kHz8BitStereo', 'DISPID_SVSLastResult',
    'DISPID_SRCEInterference', 'SPVPRIORITY',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SVEAudioLevel',
    'SpStreamFormatConverter', 'SpVoice',
    'SpeechDictationTopicSpelling', 'SPFILEMODE',
    'SREPropertyStringChange', 'SAFT22kHz8BitMono',
    'ISpPhoneticAlphabetConverter', 'SPSModifier',
    'DISPID_SpeechCustomStream', 'ISpeechPhraseElement',
    'SpeechGrammarState', 'ISpeechRecognizer', 'SPEI_TTS_BOOKMARK',
    'DISPID_SRCCreateGrammar',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SVSRunningState', 'DISPID_SLAddPronunciationByPhoneIds',
    'ISpeechObjectTokenCategory', 'SVP_17',
    'ISpeechPhraseReplacement', 'SPSHORTCUTPAIRLIST',
    'DISPID_SRCPause', 'DISPID_SRSClsidEngine',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SLPType',
    'DISPID_SGRSAddWordTransition', 'DISPID_SpeechPhraseElement',
    'DISPID_SRDisplayUI', 'DISPID_SRGDictationSetState',
    'STSF_LocalAppData', 'ISpeechFileStream', 'SPAUDIOBUFFERINFO',
    'ISpeechVoice', 'SVP_2', 'SVP_12', 'DISPID_SRCEAudioLevel',
    'SAFT32kHz16BitMono', 'SAFTCCITT_uLaw_11kHzMono',
    'SpeechAudioFormatGUIDWave', 'SPBO_TIME_UNITS',
    'SpeechCategoryRecognizers', 'SAFT8kHz8BitMono',
    'DISPID_SRCVoicePurgeEvent', 'SpeechPropertyComplexResponseSpeed',
    'SpeechVoiceSkipTypeSentence', 'SAFTGSM610_44kHzMono',
    'SpLexicon', 'SPSHORTCUTTYPE', 'SPRST_INACTIVE',
    'DISPID_SPRulesCount', 'eWORDTYPE_ADDED', 'DISPID_SRAudioInput',
    'SAFTText', 'ISpStreamFormat', 'SPRS_INACTIVE', 'ISpMMSysAudio',
    'DISPID_SRRAlternates', 'SVP_13', 'SpMMAudioIn',
    'ISpRecoGrammar2', 'SAFTGSM610_8kHzMono', 'DISPID_SWFEExtraData',
    'SVP_4', 'DISPID_SVSpeakStream', 'DISPID_SRRGetXMLResult',
    'SRTStandard', 'DISPID_SRProfile', 'SpSharedRecoContext',
    'SAFT11kHz16BitStereo', 'SPBO_NONE', 'DISPID_SPCPhoneToId',
    'SAFT22kHz8BitStereo', 'ISpRecognizer2', 'DISPID_SVVoice',
    'SPCT_COMMAND', 'DISPID_SPEsItem', 'SP_VISEME_18',
    'SpeechCategoryPhoneConverters', 'SPBOOKMARKOPTIONS',
    'SAFTCCITT_ALaw_8kHzMono', 'SAFT11kHz16BitMono',
    'SAFT44kHz8BitStereo', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPSHT_Unknown', 'STCLocalServer', 'DISPID_SPRsItem',
    'DISPID_SpeechPhraseElements', 'ISpeechWaveFormatEx',
    'SAFTCCITT_uLaw_22kHzStereo', 'SVPOver', 'SpeechAddRemoveWord',
    'SAFTADPCM_8kHzStereo', 'DISPID_SpeechGrammarRuleStateTransition',
    'SAFTGSM610_11kHzMono', 'DISPID_SVEVoiceChange',
    'ISpeechRecoResult2', 'DISPID_SVEViseme', 'SP_VISEME_9',
    'SREPropertyNumChange', 'DISPID_SPIReplacements',
    'DISPID_SPAsItem', 'SpMMAudioOut', 'SVP_19',
    'DISPID_SPPConfidence', 'DISPID_SRRTStreamTime',
    'DISPID_SLPLangId', 'SAFTCCITT_ALaw_8kHzStereo', 'ISpRecoContext',
    'SSTTDictation', 'DISPID_SDKDeleteKey', 'SPAS_PAUSE',
    'SpeechRetainedAudioOptions', 'SP_VISEME_19',
    'SRSInactiveWithPurge', 'DISPID_SRCreateRecoContext',
    'Speech_StreamPos_RealTime', 'SAFT16kHz8BitMono', 'SRARoot',
    'SPAS_RUN', 'DISPID_SRRAudioFormat', 'DISPID_SGRInitialState',
    'SVP_9', 'eLEXTYPE_PRIVATE3', 'SPCT_SUB_COMMAND',
    'SVSFUnusedFlags', 'SVP_11', 'SRSActive', 'SVP_5', 'SINoise',
    'SVSFParseSsml', 'SAFTADPCM_22kHzMono', 'DISPID_SVResume',
    'SPEI_MAX_TTS', 'STSF_AppData', 'ISpeechObjectToken', 'SVSFIsXML',
    'DISPID_SPIGetText', 'SITooSlow', 'SPFM_NUM_MODES',
    'SPPS_RESERVED4', 'DISPID_SLWsCount', 'ISpeechPhraseAlternate',
    'Speech_Default_Weight', 'SPWORDPRONUNCIATION',
    'SGPronounciation', 'DISPIDSPRG', 'ISpeechAudioBufferInfo',
    'SpeechWordType', 'DISPID_SMSAMMHandle', 'DISPID_SVPause',
    'DISPID_SPPValue', 'DISPID_SVSInputSentencePosition',
    'DISPID_SPRulesItem', 'DISPID_SGRSTransitions',
    'SpeechAudioFormatType', 'SPEI_START_INPUT_STREAM',
    'DISPID_SPPsItem', 'DISPID_SVVolume', 'SPEI_END_INPUT_STREAM',
    'DISPID_SLWs_NewEnum', 'SPEI_START_SR_STREAM',
    'DISPID_SVGetProfiles', 'eLEXTYPE_USER', 'DISPID_SMSADeviceId',
    'SpeechVisemeFeature', 'SP_VISEME_1',
    'DISPID_SPEDisplayAttributes', 'SpeechVisemeType', 'SP_VISEME_20',
    ...
    'SPRST_INACTIVE_WITH_PURGE', 'eLEXTYPE_RESERVED10',
    'DISPID_SBSWrite', 'SVSFPurgeBeforeSpeak', 'DISPID_SVSPhonemeId',
    'SGRSTTEpsilon', 'ISpStream', 'DISPID_SVIsUISupported',
    'DISPID_SpeechFileStream', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SpeechRecoResult2', 'SPSMF_SAPI_PROPERTIES', 'SPWORD',
    'SSTTWildcard', 'SDTPronunciation',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SVSVisemeId',
    'DISPID_SpeechLexiconWord', 'DISPID_SDKGetStringValue',
    'DISPID_SRCCmdMaxAlternates', 'SREAllEvents',
    'DISPID_SAEventHandle', 'eLEXTYPE_PRIVATE7', 'DISPID_SRGId',
    'DISPID_SVAudioOutputStream', 'SPEI_RECO_OTHER_CONTEXT',
    'SPAO_NONE', 'SPRECOGNIZERSTATUS', 'ISpeechPhraseRules',
    'SREHypothesis', 'ISpeechGrammarRuleState', 'SAFT12kHz8BitStereo',
    'DISPID_SOTCGetDataKey', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SpeechMMSysAudio', 'SpeechRecognitionType',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SpeechRecoContext',
    'SWTDeleted', 'DISPID_SRAudioInputStream', 'SLOStatic',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SGRsFindRule',
    'DISPID_SPAPhraseInfo', '__MIDL_IWinTypes_0009', 'SREBookmark',
    'DISPID_SOTIsUISupported', 'SPWORDLIST', 'DISPID_SPISaveToMemory',
    'ISpeechLexicon', 'DISPIDSPTSI_ActiveLength',
    'SPRS_ACTIVE_USER_DELIMITED', 'ISpeechGrammarRules', 'SVP_16',
    'SGRSTTWord', 'SRADefaultToActive', 'DISPID_SMSALineId',
    'SpUnCompressedLexicon', 'SITooLoud', 'SAFT16kHz16BitMono',
    'SPEI_RECOGNITION', 'SpeechAudioVolume',
    'DISPID_SPIAudioStreamPosition', 'SpeechTokenContext',
    'SDA_One_Trailing_Space', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SPIElements', 'DISPID_SASetState', 'SPDKL_LocalMachine',
    'SpeechDataKeyLocation', 'DISPID_SVRate', 'SPPHRASEREPLACEMENT',
    'SRADynamic', 'ISpEventSink', 'DISPID_SRGCmdLoadFromFile',
    'SPEI_SR_BOOKMARK', 'SPEI_MIN_SR', 'ISpeechPhraseInfoBuilder',
    'DISPID_SVEventInterests', 'SPEI_PROPERTY_NUM_CHANGE',
    'SpeechPropertyResourceUsage', 'SpeechUserTraining',
    'SpInProcRecoContext', 'SITooQuiet', 'DISPID_SLAddPronunciation',
    'SVP_18', 'eLEXTYPE_RESERVED4', 'DISPID_SpeechAudioBufferInfo',
    'ISpeechPhraseInfo', 'DISPID_SVSLastBookmark',
    'SSFMCreateForWrite', 'SP_VISEME_6', 'SINone', 'SPSSuppressWord',
    'SpeechAudioFormatGUIDText', 'DISPID_SGRsCommit',
    'SPDATAKEYLOCATION', 'DISPID_SPIRule',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SRRecognizer',
    'DISPID_SpeechObjectToken',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPPS_RESERVED2', 'DISPID_SPPEngineConfidence', 'SRERecognition',
    'DISPID_SOTCDefault', 'SpeechInterference',
    'DISPID_SDKSetBinaryValue', 'SDTLexicalForm',
    'DISPID_SPEAudioStreamOffset', 'SPRECOCONTEXTSTATUS',
    'STCInprocServer', 'SP_VISEME_3', 'ISpeechLexiconPronunciations',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPFM_CREATE_ALWAYS',
    'DISPID_SpeechWaveFormatEx',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SRStatus', 'ISpeechRecoResultTimes',
    'DISPID_SRCERecognition', 'SAFTNoAssignedFormat',
    'SAFT12kHz16BitStereo', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SPEPronunciation', 'ISpeechRecoResultDispatch',
    'SPWF_INPUT', 'ISpeechGrammarRuleStateTransitions',
    'SPINTERFERENCE_TOOQUIET', '_RemotableHandle',
    'ISpeechLexiconWords', 'ISpeechRecognizerStatus',
    'SPRST_NUM_STATES', 'DISPID_SPIRetainedSizeBytes',
    'SpeechTokenValueCLSID', 'DISPID_SLGetGenerationChange',
    'DISPID_SRRPhraseInfo', 'SP_VISEME_17', 'SpNullPhoneConverter',
    'DISPID_SPPChildren', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SpeechObjectTokens', 'DISPID_SVGetAudioOutputs',
    'SREInterference', 'SAFT24kHz16BitMono', 'DISPID_SPILanguageId',
    'SREStreamStart', 'DISPID_SRGState',
    'DISPID_SPERetainedStreamOffset', 'ISpeechObjectTokens',
    'SPAUDIOSTATE', 'SPSEMANTICERRORINFO', 'SGLexical',
    'DISPID_SPIProperties', 'DISPID_SpeechRecognizer',
    'SECFIgnoreWidth', 'ISpeechAudio', 'DISPID_SRGCmdSetRuleState',
    'SPPS_Unknown', 'DISPID_SOTMatchesAttributes', 'SPEI_MAX_SR',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SRCEEnginePrivate',
    'SPEI_TTS_PRIVATE', 'DISPIDSPTSI', 'ISpeechPhoneConverter',
    'SGSExclusive', 'ISpObjectToken', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SGRAttributes', 'SpeechFormatType', 'SPSHT_OTHER',
    'SpMMAudioEnum', 'DISPID_SPRsCount', 'SVP_8', 'SPEI_RESERVED1',
    'DISPID_SRCState', 'SpeechStreamSeekPositionType',
    'DISPID_SRGetPropertyNumber', 'SpeechTokenKeyAttributes',
    'SAFT44kHz8BitMono', 'SVSFDefault', 'DISPID_SWFEBitsPerSample',
    'DISPID_SPEAudioTimeOffset', 'SPSHT_EMAIL', 'SRAORetainAudio',
    'SVP_21', 'DISPID_SpeechPhraseInfo', 'DISPID_SRCEHypothesis',
    'DISPID_SREmulateRecognition', 'DISPID_SpeechPhraseBuilder',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SPWORDPRONUNCIATIONLIST', 'SDKLCurrentUser',
    'SAFT48kHz16BitMono', 'STSF_CommonAppData',
    'DISPID_SDKGetlongValue', 'SRSInactive', 'SPVPRI_OVER',
    'DISPID_SGRSTPropertyValue', 'SAFT12kHz8BitMono', 'SVSFlagsAsync',
    'SpeechVoiceEvents', 'DISPID_SRCEFalseRecognition',
    'SPEI_UNDEFINED', 'SPEVENT', 'DISPID_SCSBaseStream',
    'DISPID_SVSkip', 'SPTEXTSELECTIONINFO', 'DISPID_SGRsAdd',
    'SDTRule', 'SSFMCreate', 'SPSVerb', 'SPSFunction',
    'DISPID_SOTDisplayUI', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SGRsDynamic', 'DISPID_SPERetainedSizeBytes',
    '_ISpeechRecoContextEvents', 'SVEPhoneme',
    'SAFTCCITT_ALaw_22kHzMono', 'SVP_1', 'SDTReplacement',
    'SPPHRASEELEMENT', 'SAFT11kHz8BitMono',
    ...
    'SPBO_AHEAD', 'SGLexicalNoSpecialChars', 'ISpeechPhraseProperty',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SASNonBlockingIO', 'eLEXTYPE_PRIVATE15',
    'SPDKL_CurrentUser', 'SAFT44kHz16BitMono', 'eLEXTYPE_PRIVATE8',
    'SRERecoOtherContext', 'DISPID_SDKEnumKeys',
    'DISPID_SDKSetStringValue', 'eLEXTYPE_PRIVATE18',
    'DISPID_SRCEPhraseStart', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SAFT32kHz16BitStereo', 'ISpPhoneticAlphabetSelection',
    'SpeechTokenShellFolder', 'DISPID_SLPs_NewEnum', 'SDTAlternates',
    'DISPID_SOTRemoveStorageFileName', 'SPINTERFERENCE_NONE',
    'ISpResourceManager', 'SPEI_RESERVED6', 'SpeechRuleState',
    'SP_VISEME_2', 'DISPID_SRSAudioStatus',
    'SpeechGrammarTagDictation', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SRGSetTextSelection',
    'ISpSerializeState', 'STCAll', 'DISPID_SOTCEnumerateTokens',
    'SAFTCCITT_ALaw_11kHzStereo', 'SREPhraseStart',
    'DISPID_SPRuleConfidence',
    'SpeechPropertyHighConfidenceThreshold', 'SVSFPersistXML',
    'ISpPhraseAlt', 'ISpeechLexiconPronunciation',
    'eLEXTYPE_RESERVED8'
]

_check_version('1.2.1', 1700081502.812531)
